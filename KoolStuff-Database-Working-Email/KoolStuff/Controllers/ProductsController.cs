...
namespace KoolStuff.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            ViewData["Id"] = new SelectList(_context.Product, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Quantity,Price,Image")] Product product)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Product, "Id", "Name", product.Id);
            return View(product);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Product, "Id", "Name", product.Id);
            return View(product);
        }
